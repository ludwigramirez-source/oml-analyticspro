        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Total Llamadas</th>
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">% Tasa Atención</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">TMO (Tiempo Medio)</th>
            </tr>
          </thead>
            ...
            {agentes.length === 0 ? (
              ...
              agentes.map((agente, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-center text-gray-700 font-medium">{agente.total_llamadas}</td>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-blue-600 font-medium">{formatTiempo(agente.tmo)}</td>
                </tr>
              ))
            )}
          </tbody>
